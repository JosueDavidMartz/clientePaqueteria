...
public class ConexionWS {
    ...
    public static RespuestaHTTP peticionGET(String url){
        ...
        try {
            ...
            int codigoRespuesta = conexionHttp.getResponseCode(); //realiza la peticion y devuelve la respuesta
    ...
    public static RespuestaHTTP peticionPOST(String url, String parametros){
        ...
        try {
            ...
            conexionHttp.setDoOutput(true);//pone el cuerpo de la peticion en modo escritura
